...
principal='main_SIRS_Estocastico_grafo_estrela.f90'
#=======================================================================
...
IFS=' '
#=======================================================================
executavel='star_t'${num_base}${nzeros}g${gama_sp}'a'${alp_arr[0]}'p'${alp_arr[1]}
#=======================================================================
...
if [[ ${maquina} == 'casa' ]];then
   ...
   #--------------------------------------------------------------------
   qsub -N ${executavel} -cwd executa_sirs_est_grafo_estrela.sh ${executavel} ${tam_rede} ${lamb0} ${divisor} ${alp} ${n_lamb} ${tTotal} ${tRelax} ${interpola}
   #--------------------------------------------------------------------
else
   #--------------------------------------------------------------------
